...
- Created and maintained in depth documentation and instructions for the customer and their technical team.
- Updating code to conform with strict security standards. For example: clickjacking, Log Injection, Cross-Site Scripting.
...
**Inchcape Connect Intranet Site**
...
***Technologies:** Liferay 6, AEM 6.2, JavaScript, MySql, HTML, Java 1.6*