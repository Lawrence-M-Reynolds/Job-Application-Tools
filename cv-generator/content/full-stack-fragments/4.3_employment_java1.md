...
- Led a database migration of spreadsheet-based business data. Collaborated with stakeholders to map spreadsheet data to the schema. Developed, documented, and rigorously tested robust SQL scripts, ensuring a successful release first time.
